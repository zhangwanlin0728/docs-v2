...
menu:
  influxdb_cloud_iox:
    name: SQL profiling tools
    parent: SQL reference
weight: 230
---

SQL query profiling tools display the execution plan for a given SQL query. 

 - The `EXPLAIN` command shows the execution plan of a SQL query.
 - The `EXPLAIN VERBOSE` command provides a more verbose execution plan of the query.
 - The `EXPLAIN ANALYZE` command provides the execution plan and metrics of the query. 


 [EXPLAIN](#explain-caommnd)
